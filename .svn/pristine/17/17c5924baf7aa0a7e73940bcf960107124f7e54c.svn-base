...
from loongtian.util.text.edit_distance import edit_distance_backpointer
from loongtian.util.text.edit_distance import edit_distance
from loongtian.util.text.edit_distance import highest_match_action
...
class TestEditDistance(unittest.TestCase):
    ...
    def test1(self):
        ...
        sm = SequenceMatcher(a=list(str1), b=list(str2))
        self.assertEqual(sm.distance(),  5)
        print sm.get_opcodes()
        target_opcodes =[['equal', 0, 1, 0, 1],
                         ['replace', 1, 2, 1, 2],
                         ['equal', 2, 3, 2, 3],
                         ['replace', 3, 4, 3, 4],
                         ['equal', 4, 5, 4, 5],
