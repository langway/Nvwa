...
class TestCollection(TestCase):
    ...
    def testSaveCollection(self):
        ...
        # print "Chain1<%s> = [[['甲', '乙'], '丙'], '丁']" % self.chain1.kid
        ...
        # print "Chain1<%s> = ['如果', '那么']" % self.chain1.kid

    def tearDown(self):
        print ("----tearDown----")
        # DbPool.executeSQL([
        #     "delete from MetaData where isdel = true",
        #     "delete from RealObject where isdel = true",
        #     "delete from MetaReal where isdel = true",
        #     "delete from Knowledge where isdel = true",
        #     "delete from Forward where isdel = true",
        #     "delete from Domain where isdel = true"
        # ])