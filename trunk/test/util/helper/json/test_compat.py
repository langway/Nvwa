...
class TestJSONPlus(unittest.TestCase):
    ...
    def test_basic_dumps(self):
        print (json.dumps(self.basic, sort_keys=True))
        self.assertEqual(json.dumps(self.basic, sort_keys=True), self.basic_dumps)
    
    def test_basic_encode(self):
        print (simplejson.dumps(self.basic, sort_keys=True, cls=json.JSONEncoder))
        self.assertEqual(
    ...
    def test_plus_dumps(self):
        print (json.dumps(self.plus, sort_keys=True))
