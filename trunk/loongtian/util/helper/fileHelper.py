...
def readLines(filename):
    ...
    try:
        ...
        errorMsg = 'file open error: {0},file:{1}'.format(err,filename)
        ...
        try:
            ...
            errorMsg = 'file open codec error: {0},file:{1}'.format(ex,filename)
            logger.error(errorMsg)
            print(errorMsg)
    except Exception as ex:
        errorMsg = 'file open or read error: {0},file:{1}'.format(ex, filename)
        logger.error(errorMsg)
        print(errorMsg)
