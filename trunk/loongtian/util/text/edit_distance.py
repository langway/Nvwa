...
class SequenceMatcher(object):
    ...
    def __init__(self, a=None, b=None, test=operator.eq,
        ...
        self.seq2 = b
        self._reset_object()
        if matchType==MatchType.Highest:
            self.action_function = highest_match_action
        else:
            self.action_function = lowest_cost_action
