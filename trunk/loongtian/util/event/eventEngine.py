...
from loongtian.autotrade.trader.vtEvent import *
...
class EventEngine(object):
    ...
    def __init__(self):
        ...
        # 数据引擎，作为各gateway数据之间的通讯桥梁
        self.data_engine = None

        # 主引擎，作为各gateway数据之间的通讯桥梁
...
class EventEngine2(object):
    ...
    def __init__(self):
        ...
        # 事件处理线程
        self.s__thread = Thread(target = self.__run)
